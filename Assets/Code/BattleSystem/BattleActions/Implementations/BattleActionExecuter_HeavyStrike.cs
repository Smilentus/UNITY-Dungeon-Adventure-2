...
{
    public class BattleActionExecuterHeavyStrike : BattleActionExecuterBaseActionExecuter
    {
        public override void ExecuteAction()
        {
            ...
            if (!_runtimeBattlePlayerController.CriticalStrike())
            {
                ...
                {
                    double dmg = _runtimePlayer.RuntimePlayerStats.Damage * 2;
                    ...
                    {
                        if (UnityEngine.Random.Range(0, 101) <= _runtimePlayer.RuntimePlayerStats.HeavyStrikeChance + _runtimePlayer.RuntimePlayerStats.Luck)
                        {
